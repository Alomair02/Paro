...
ALLOWED_ATTRS = {
    ...
    | GRID_PLACEMENT_ATTRS
    | GEOMETRY_ATTRS,
    "funnel": {"gap", "labelSize", "tip"} | GRID_PLACEMENT_ATTRS | GEOMETRY_ATTRS,
    "stage": {"fill", "color", "size"},
    "process": {"gap", "labelSize"} | GRID_PLACEMENT_ATTRS | GEOMETRY_ATTRS,
    "step": {"fill", "color", "size"},
    "pyramid": {"gap", "labelSize", "tip"} | GRID_PLACEMENT_ATTRS | GEOMETRY_ATTRS,
    "tier": {"fill", "color", "size"},
    "venn": {"alpha", "labelSize"} | GRID_PLACEMENT_ATTRS | GEOMETRY_ATTRS,
    "set": {"fill", "color", "size"},
    "categories": set(),
...
ALLOWED_CHILDREN = {
    ...
    "stack": {"stack", "grid", "free", "text", "image", "shape", "line", "table", "timeline", "chart", "use", "funnel", "process", "pyramid", "venn"},
    "grid": {"stack", "grid", "free", "text", "image", "shape", "line", "table", "timeline", "chart", "use", "funnel", "process", "pyramid", "venn"},
    "free": {"stack", "grid", "free", "text", "image", "shape", "line", "table", "timeline", "chart", "use", "funnel", "process", "pyramid", "venn"},
    "text": {"p"},
    "p": {"run"},
    "shape": {"text"},
    "table": {"row"},
